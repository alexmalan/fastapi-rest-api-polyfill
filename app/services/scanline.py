...
def fillTA(TA, max_y, x_points, y_points):
    """
    Fill the Edge table list with the polygon edges.

    :param TA: Edge table list
    :param max_y: maximum y coordinate of the polygon
    :param x_points: list of x coordinates of polygon vertices
    :param y_points: list of y coordinates of polygon vertices
...
def polyfill(TA):
    ...
    :return: list of points to be filled through
    """
...
def fill_polygon_scanline(xp: list, yp: list):
    """
    Scanline polygon fill algorithm.

    :param xp: list of x coordinates of polygon vertices
    :param yp: list of y coordinates of polygon vertices
